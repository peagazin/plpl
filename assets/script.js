...
$(document).ready(function(){
    ...
    const mudaTela = ( atual, nova = null, animacao = "fade", tempoAnimacao = 900 ) => {
        ...
        $("html, body").animate({ scrollTop: 0 }, "slow");
        if(nova == 15){
            var audio = new Audio('assets/deserve.mp3');
            audio.volume = 0.1;
            audio.play();
        }
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            ...
            case "28/12": titulo = "28 de Dezembro de 2022"; mensagem = "<section class='text-center'><p class='letra-vermelha'><strong>Dia que eu te vi e te achei a mulher mais linda do mundo.</strong></p></section>";break;
            case "31/12": titulo = "31 de Dezembro de 2022"; mensagem = "<section class='text-center'><p class='letra-vermelha'><strong>Este momento está sendo escrito agora...</strong></p></section>";break;
            case "final": titulo = "x"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
